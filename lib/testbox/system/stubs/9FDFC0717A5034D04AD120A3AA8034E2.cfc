...
<cffunction access="public" hint="Expire all the elments in the cache (if supported by the provider)" returnformat="wddx" returntype="void" output="false" closure="false" modifier="" name="expireAll" owner="/home/travis/build/Ortus-Solutions/TestBox/tests/resources/coldbox/system/cache/ICacheProvider.cfc" description="">
</cffunction>
...
<cffunction access="public" hint="Get an object from the cache without updating stats or listners" returnformat="wddx" returntype="any" output="false" closure="false" modifier="" name="getQuiet" owner="/home/travis/build/Ortus-Solutions/TestBox/tests/resources/coldbox/system/cache/ICacheProvider.cfc" description="">
<cfargument required="true" hint="The object key" name="objectKey" type="any">
</cffunction>
