<cfscript>
			variables[ "foo" ] = variables[ "tmp_foo_CAB0DEC1CE0CD352237CDACD91147536" ];
			this[ "foo" ] = variables[ "tmp_foo_CAB0DEC1CE0CD352237CDACD91147536" ];
			// Clean up
			structDelete( variables, "tmp_foo_CAB0DEC1CE0CD352237CDACD91147536" );
			structDelete( this, "tmp_foo_CAB0DEC1CE0CD352237CDACD91147536" );

			public any function tmp_foo_CAB0DEC1CE0CD352237CDACD91147536( 
			...
			arrayAppend(this._mockCallLoggers["foo"], arguments);
